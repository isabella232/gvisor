...
// StackFactory creates a network stack from a clock.
type StackFactory func(tcpip.Clock) (inet.Stack, error)

// LoadFrom returns a new Kernel loaded from args.
func (k *Kernel) LoadFrom(ctx context.Context, r wire.Reader, netFactory StackFactory, clocks sentrytime.Clocks, vfsOpts *vfs.CompleteRestoreOptions) error {
	loadStart := time.Now()
