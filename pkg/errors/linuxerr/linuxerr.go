...
var notValidLinuxerr = errors.New(errno.Errno(maxErrno), "not a valid error")
...
var errorSlice = []*errors.Error{
	...
	errno.ELOOP:           ELOOP,
	errno.ELOOP + 1:       notValidLinuxerr, // No valid errno between ELOOP and ENOMSG.
	errno.ENOMSG:          ENOMSG,
	errno.EIDRM:           EIDRM,
	errno.ECHRNG:          ECHRNG,
	...
	errno.EBADSLT + 1:     notValidLinuxerr, // No valid errno between EBADSLT and ENOPKG.
	errno.EBFONT:          EBFONT,
	errno.ENOSTR:          ENOSTR,
	errno.ENODATA:         ENODATA,
	errno.ETIME:           ETIME,
	errno.ENOSR:           ENOSR,
	errno.ENOSR + 1:       notValidLinuxerr, // No valid errno betweeen ENOSR and ENOPKG.
	errno.ENOPKG:          ENOPKG,
